...
License  : GPL-2.0 MIT
Requires: validators-python = %{version}-%{release}
Requires: validators-python3 = %{version}-%{release}
Requires: decorator
Requires: hypothesis
Requires: pyparsing
Requires: six
...
%package python
Summary: python components for the validators package.
Group: Default
Requires: validators-python3 = %{version}-%{release}

%description python
python components for the validators package.


%package python3
Summary: python3 components for the validators package.
Group: Default
Requires: python3-core
Provides: pypi(validators)
Requires: pypi(decorator)
Requires: pypi(six)

%description python3
python3 components for the validators package.


%prep
%setup -q -n validators-0.18.2
cd %{_builddir}/validators-0.18.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629727655
